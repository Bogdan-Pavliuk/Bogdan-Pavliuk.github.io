...
document.querySelector(".header_btn").onclick = function dropMenu(){
    document.querySelector("#drop_inner").classList.toggle("act");
    document.querySelector("#header_btn_drop").classList.toggle("act");
}